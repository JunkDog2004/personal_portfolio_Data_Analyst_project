...
# --- GEMINI INSIGHT (reads API key from Streamlit Secrets) ---
def get_gemini_insight(df_summary, task):
    try:
        import google.generativeai as genai

        # Read key from Streamlit Secrets (set via Manage App > Settings > Secrets)
...
st.markdown("---")
st.caption("AutoML Deployment Agent | Built with Streamlit & Scikit-learn")import streamlit as st
import pandas as pd
import numpy as np
import matplotlib.pyplot as plt
import shap
